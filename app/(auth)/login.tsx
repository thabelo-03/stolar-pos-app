    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        if (data.role === 'admin') {
          ...
          // 2. Manager lands on the Hub (index.tsx)
          // This allows them to choose between Operation Hub or Registering more shops
      ...
      // Consistent with your previous server setup
      ...
      <View style={styles.form}>
        ...
        >
          <Text style={styles.signupLinkText}>
            Need access? <Text style={styles.signupLinkHighlight}>Register Staff</Text>
          </Text>
        </TouchableOpacity>
      </View>
